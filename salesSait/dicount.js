...
giveaway.textContent = `Now you can buy with 50% discount only 15 days, ${week} ${date} ${month} ${year} ${hours}:${minutes}am`
// future time
...
function getRemaining(){
    ...
    if(time < 0){
        ...
        daysOffert.innerHTML = `<h4 class="expired"> sorry, this has expired</h4>`
    }
}
